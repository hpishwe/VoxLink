...
MODELS = {
    "Pratham": Path("models/hindi/hi_IN-pratham-medium.onnx"),
    "Priyamvada": Path("models/hindi/priyamvada/hi_IN-priyamvada-medium.onnx"),
    "Rohan": Path("models/hindi/rohan/hi_IN-rohan-medium.onnx"),
}
...
print("=" * 70)
print("PSS HINDI TTS MODEL COMPARISON")
print("=" * 70)
