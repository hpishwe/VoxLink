...
MODELS = {
    "Maya": Path("models/telugu/te_IN-maya-medium.onnx"),
    "Padmavathi": Path("models/telugu/te_IN-padmavathi-medium.onnx"),
    "Venkatesh": Path("models/telugu/te_IN-venkatesh-medium.onnx"),
}


SENTENCES = [
    "నాకు సహాయం అవసరం.",
    "దయచేసి వెంటనే సహాయం పంపండి.",
    "నేను సురక్షితంగా ఉన్నాను.",
    "నాకు గాయమైంది.",
    "మా స్థానం సెక్టార్ ఐదు సమీపంలో ఉంది.",
    "మంటలు చెలరేగాయి.",
    "వెంటనే సహాయం అవసరం.",
    "దయచేసి పోలీసులకు తెలియజేయండి.",
    "దయచేసి సమీపంలోని ఆసుపత్రిని సంప్రదించండి.",
    "ఇది ఒక అత్యవసర సందేశం.",
]
...
print("=" * 70)
print("PSS TELUGU TTS MODEL COMPARISON")
print("=" * 70)
...
for model_name, model_path in MODELS.items():
    ...
    for i, sentence in enumerate(SENTENCES, start=1):
        ...
        output_dir = Path("output") / "comparison" / "telugu" / model_name.lower()
